...
describe('Outlet API:', function() {
  ...
  describe('PUT /api/outlets/:id', function() {
    ...
    it('should respond with the updated outlet', function() {
      expect(updatedOutlet.name).to.equal('Updated Outlet');
      expect(updatedOutlet.info).to.equal('This is the updated outlet!!!');
    });
